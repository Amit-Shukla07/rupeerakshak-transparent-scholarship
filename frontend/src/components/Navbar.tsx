...
export const Navbar = () => { // Renamed from HeroHeader
    ...
    const getMenuItems = () => {
        ...
        if (currentPath === '/user') {
            return [
                { name: 'Process', to: '/user#how-it-works-section', description: 'How the scholarships are distributed' },
                { name: 'Ledger', to: '/ledger', description: 'Public scholarship transaction' },
                { name: 'Dashboard', to: '/user-dashboard', description: 'Your scholarship dashboard' },
            ];
        }

        // Default menu items for other pages
        const baseItems = [
            { name: 'Features', to: '/#features-section', description: 'Transparent scholarship distribution' },
            { name: 'How It Works', to: '/#how-it-works-section', description: 'Simple scholarship flow' },
            { name: 'Find Students', to: '/find-students', description: 'View and donate to students' }, // NEW LINK
            { name: 'Apply for Scholarship', to: '/register-student', description: 'Get funding for your education' },
            { name: 'About', to: '/about', description: 'Our mission for fair education funding' },
            { name: 'Transparency', to: '/transparency', description: 'Public scholarship ledger' },
        ];
                                            ...
                                            <DropdownMenuContent align="end" className="w-64" sideOffset={8}>
                                                <DropdownMenuLabel className="font-normal">
                                                    <div className="flex flex-col space-y-1">
                                                        <p className="text-sm font-medium leading-none"> Scholarship wallet</p>
